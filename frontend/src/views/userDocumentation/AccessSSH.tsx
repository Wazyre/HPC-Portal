    ...
    return (
        <Container fluid>
            ...
            <Card>
                ...
                <Text mt={10}>
                    If this is your first time connecting, please note that you may see an error message 
                    in XAuthority. This is normal and you can ignore it. Let (hpcdemo) be the user account 
                    name, kindly replace "hpcdemo" with your username. 
                </Text>
                <List>
