...
export type SupportWhereInput = {
  ...
  username?: Prisma.StringFilter<"Support"> | string
...
export type SupportScalarWhereWithAggregatesInput = {
  ...
  username?: Prisma.StringWithAggregatesFilter<"Support"> | string
...
export type SupportOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "username" | "name" | "subject" | "description" | "status" | "createdAt" | "updatedAt", ExtArgs["result"]["support"]>
...
export interface SupportFieldRefs {
  ...
  readonly username: Prisma.FieldRef<"Support", 'String'>
